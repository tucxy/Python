...
# Convert 'InvoiceDate' to standard datetime
...
#& ~:= x ~ y if x,y\in I for some I\in bins
#&each I\in bins which gives the equivalence class [x]_I where x\in I

#& the bijection from the equivalences classes given by each I\in bins to the set of labels in 'labels 
