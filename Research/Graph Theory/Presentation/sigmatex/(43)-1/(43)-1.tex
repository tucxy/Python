...
\draw (G1N10) -- node[midway, sloped, above, draw=none, fill=none] {\textcolor{green}{2}} (G1N8);
\draw (G1N8) -- node[midway, sloped, above, draw=none, fill=none] {\textcolor{green}{1}} (G1N9);
\end{tikzpicture}
\end{document}
