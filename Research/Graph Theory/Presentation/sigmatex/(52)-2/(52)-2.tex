...
\node[fill=black, label=below:{\color{black}$4$}] (G1N4) at (5.70,7.80) {};
\node[fill=black, label=below:{\color{black}$0$}] (G1N0) at (4.20,7.30) {};
...
\draw (G1N3) -- node[midway, sloped, above, draw=none, fill=none] {\textcolor{green}{3}} (G1N6);
