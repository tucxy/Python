...
#*(61)-2
G1 = merge(path([15,5,14,1,9,0]),path([1,11]), path([2,10]))
G2 = merge(path([14,4,13,5,18,9]),path([5,16]), path([3,12]))
G3 = merge(path([7,20,8,17,6,16]),path([4,17]), path([0,10]))
...
G3 = merge(path([12,4,17,6,15]),path([4,17]),path([6,19,7]))
...
G4 = merge(path([4,8,1,6,3]),path([6,0]),path([5,7]),path([9,10]))
