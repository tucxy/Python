...
\node[fill=black, label=below:{\color{black}$2$}] (G1N2) at (6.70,7.80) {};
\node[fill=black, label=below:{\color{black}$9$}] (G1N9) at (7.20,7.80) {};
\node[fill=black, label=below:{\color{black}$7$}] (G1N7) at (7.70,7.80) {};
\node[fill=black, label=below:{\color{black}$10$}] (G1N10) at (3.70,7.05) {};
\node[fill=black, label=below:{\color{black}$11$}] (G1N11) at (4.20,7.05) {};
