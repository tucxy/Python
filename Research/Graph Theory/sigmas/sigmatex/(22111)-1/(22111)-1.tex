...
\node[fill=black, label=below:{\color{black}$5$}] (G1N5) at (6.20,7.80) {};
\node[fill=black, label=below:{\color{black}$10$}] (G1N10) at (6.70,7.80) {};
\node[fill=black, label=below:{\color{black}$3$}] (G1N3) at (7.20,7.80) {};
\node[fill=black, label=below:{\color{black}$9$}] (G1N9) at (3.70,7.05) {};
\node[fill=black, label=below:{\color{black}$7$}] (G1N7) at (4.20,7.05) {};
\node[fill=black, label=below:{\color{black}$11$}] (G1N11) at (4.70,7.05) {};
\node[fill=black, label=below:{\color{black}$12$}] (G1N12) at (5.20,7.05) {};
...
\draw (G1N8) -- node[midway, sloped, above, draw=none, fill=none] {\textcolor{green}{3}} (G1N5);
\draw (G1N3) -- node[midway, sloped, above, draw=none, fill=none] {\textcolor{green}{7}} (G1N10);
\draw (G1N7) -- node[midway, sloped, above, draw=none, fill=none] {\textcolor{green}{2}} (G1N9);
\draw (G1N11) -- node[midway, sloped, above, draw=none, fill=none] {\textcolor{green}{1}} (G1N12);
\end{tikzpicture}
\end{document}
