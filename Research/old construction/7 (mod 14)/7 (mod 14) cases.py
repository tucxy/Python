...
#*(61)-1
G1  = merge(path([ 10, 0, 9, 1, (14+inc)%(14*t+7),( 5+inc)%(14*t+7), (15+inc)%(14*t+7)]),  path([ 3, 13]))
G2  = merge(path([ 14, 4, 13, 5, (18+inc)%(14*t+7),( 8+inc)%(14*t+7), (17+inc)%(14*t+7)]),  path([ 3, 12]))
G3  = merge(path([ 12, 2, 11, 3, (16+inc)%(14*t+7),( 6+inc)%(14*t+7), (15+inc)%(14*t+7)]),  path([ 0, (13+inc)%(14*t+7)]))
...
#*(61)-2
G1 = merge(path([ 15, 5, 14,( 1-inc)%(14*t+7),( 9-inc)%(14*t+7),( 0-inc)%(14*t+7)]), path([( 1-inc)%(14*t+7), (11-inc)%(14*t+7)]),  path([ 2, 10]))
G2 = merge(path([ 14, 4, 13, 5, (18+inc)%(14*t+7),( 9+inc)%(14*t+7)]), path([ 5, (16+inc)%(14*t+7)]),  path([ 3, 12]))
G3 = merge(path([ 7, (20+inc)%(14*t+7), 8, 17,( 6-inc)%(14*t+7), (16-inc)%(14*t+7)]), path([( 4-inc)%(14*t+7), 17]),  path([ 0, 10]))
...
#*(61)-3
G1  = merge(path([( 0-inc)%(14*t+7),( 9-inc)%(14*t+7),( 1-inc)%(14*t+7), 14, 5, (17+inc)%(14*t+7)]), path([ 5, 15]),  path([ 2, 12]))
G2  = merge(path([( 8+inc)%(14*t+7), (18+inc)%(14*t+7), 5, 13, 4, 14]), path([ 4, (16+inc)%(14*t+7)]),  path([ 7, (20+inc)%(14*t+7)]))
G3  = merge(path([ 14,( 3-inc)%(14*t+7), 16, 6, (17+inc)%(14*t+7),( 8+inc)%(14*t+7)]), path([ 4, (17+inc)%(14*t+7)]),  path([ 1, (13+inc)%(14*t+7)]))
...
#*(61)-4
G1 = merge(star(5, [ (16+inc)%(14*t+7), 15, (17+inc)%(14*t+7), 14]), path([ 14,( 1-inc)%(14*t+7), 13]),  path([ 7, (20+inc)%(14*t+7)]))
G2 = merge(star(4, [ 14, (15+inc)%(14*t+7), (16+inc)%(14*t+7), 13]), path([ 13, 5, (18+inc)%(14*t+7)]),  path([ 7, 17]))
G3 = merge(star((17+inc)%(14*t+7), [ 4,( 9+inc)%(14*t+7),( 8+inc)%(14*t+7), 6]), path([ 6, 16, 7]),  path([ 2, (15+inc)%(14*t+7)]))
...
#*(61)-5
G1 = merge(path([ (1-inc)%(14*t+7), 14, 5, 15, (2-inc)%(14*t+7)]), path([ (16+inc)%(14*t+7), 5, (17+inc)%(14*t+7)]),  path([ 9, (20+inc)%(14*t+7)]))
G2 = merge(path([ 6, 14, 4, (16+inc)%(14*t+7), 3]), path([ (15+inc)%(14*t+7), 4, 13]),  path([ 0, 9]))
G3 = merge(path([ 12, 4, (17+inc)%(14*t+7), 6, 15]), path([ (8+inc)%(14*t+7), (17+inc)%(14*t+7), (7+inc)%(14*t+7)]),  path([ 5, 13]))
...
#*(61)-6
G1 = merge(star((1-inc)%(14*t+7), [ 13, (10-inc)%(14*t+7), 14]), star(5, [ 14, (16+inc)%(14*t+7), 15]), path([ 3, 11]))
G2 = merge(star(5, [ (17+inc)%(14*t+7), (18+inc)%(14*t+7), 13]), star(4, [ 14, (15+inc)%(14*t+7), 13]), path([ 9, (20+inc)%(14*t+7)]))
G3 = merge(star(9, [ 1, 18, 17]), star(7, [ 16, (20+inc)%(14*t+7), 17]), path([ 3, 13]))
...
#*(61)-7
G1 = merge(star(5, [ (16+inc)%(14*t+7), 14, (17+inc)%(14*t+7), 15]), path([ 7, 15, (2-inc)%(14*t+7)]), path([ 1, 10]))
G2 = merge(star(14, [ 4,( 2-inc)%(14*t+7),( 3-inc)%(14*t+7), 6]), path([ 15, 6, (19+inc)%(14*t+7)]), path([ 9, 17]))
G3 = merge(star(4, [ (16+inc)%(14*t+7), 12, (17+inc)%(14*t+7), 13]), path([ 3, 13, (2-inc)%(14*t+7)]), path([ 1, 11]))
...
#*(61)-8
G1 = merge(star(15, [ 7, 6, 5,( 3-inc)%(14*t+7),( 2-inc)%(14*t+7)]), path([( 2-inc)%(14*t+7), 13]), path([ 12, 20]))
G2 = merge(star(14, [ 6, 5, 4,( 3-inc)%(14*t+7),( 2-inc)%(14*t+7)]), path([( 2-inc)%(14*t+7), (10-inc)%(14*t+7)]), path([ 9, 19]))
G3 = merge(star(4, [ (16+inc)%(14*t+7), (15+inc)%(14*t+7), 12, 13, (17+inc)%(14*t+7)]), path([ (17+inc)%(14*t+7), 6]), path([ 10, 19]))
...
G2 = merge(path([ 6, 14, 4, 12, 2]), path([ 4, 13,( 1-inc)%(14*t+7)]), path([ 5, 15]))
G3 = merge(path([ (13+inc)%(14*t+7), 2, 10, 19,( 7-inc)%(14*t+7)]), path([ 10, 1, 11]), path([ 12, 20]))
...
#*(61)-10
G1 = merge(star(5, [ (17+inc)%(14*t+7), (16+inc)%(14*t+7), 15]), path([ 7, 15,( 2-inc)%(14*t+7), 14]), path([ 4, 12]))
G2 = merge(star(14, [ 4,( 3-inc)%(14*t+7), 6]), path([ 16, 6, (19+inc)%(14*t+7), 7]), path([ 1, 10]))
G3 = merge(star(13, [ 3,( 1-inc)%(14*t+7), 4]), path([ (16+inc)%(14*t+7), 4, (17+inc)%(14*t+7),( 9+inc)%(14*t+7)]), path([ 8, 18]))
...
#*(52)-1
G1 = merge(path([( 0-inc)%(14*t+7),( 9-inc)%(14*t+7),( 1-inc)%(14*t+7), 14, 5, 15]),  path([ 17, 7, (20+inc)%(14*t+7)]))
G2 = merge(path([ 14, 4, 13, 5, (18+inc)%(14*t+7),( 8+inc)%(14*t+7)]),  path([ 12, 3, (15+inc)%(14*t+7)]))
G3 = merge(path([ 12, 2, 11, 3, (16+inc)%(14*t+7),( 6+inc)%(14*t+7)]),  path([ (10+inc)%(14*t+7), (20+inc)%(14*t+7), 8]))
